...
import ContractExtensionTable from '../views/ContractExtensionTable'
...
class UpdateContractExtension extends React.Component {
    ...
    onGetlink() {
        const el = "http://localhost:3000/admin/Contract/" + this.props.contractEx.id
        el.select()
    ...
    componentDidMount() {
        this.setState({
            contractNum: this.props.contractEx.contractNum,
            contractName: this.props.contractEx.contractName,
            contractValue: this.props.contractEx.contractValue,
            contractContent: this.props.contractEx.contractContent,

            contractTitle: this.props.contractEx.contractTitle,
            contractPlace: this.props.contractEx.contractPlace,
            contractExpiredDate: this.props.contractEx.contractExpiredDate,
        })
        axios({
    ...
    onUpdate = () => {
        ...
        axios({
            url: "/api/v1/Contract/" + this.props.contractEx.id,
            method: "POST",
            headers: {
                Authorization: "Bearer " + this.props.token,
    ...
    render() {
        ...
        const config = {
            ...
            if (this.state.finish) {
                return (
                    <Router>
                    <Redirect push to={"/admin/viewContract/" + hash.sha1(this.props.contract.id) + "/viewExtension"} />
                    <Route exact path="/admin/viewContract/:id/viewExtension" render={() => <ContractExtensionTable contract={this.props.contract}  role={this.props.role} />
                    } /></Router>
                );
            } else {
                return (
                                ...
                                <Card>
                                    ...
                                    >
                                        ...
                                        <Space size="large">
                                            ...
                                            <CopyToClipboard text={"http://localhost:3000/admin/Contract/" + this.props.contractEx.id}
